...
/**
    ...
    public void registerGoal(String scorerName, String assistantName, int minute) {
        Player scorer = new Player(scorerName);
        Player assistant = (assistantName != null && !assistantName.isEmpty()) ? new Player(assistantName) : null;

        currentGoal = new Goal(scorer, assistant, minute);
    }
    ...
    public void registerCard(String playerName, String team, String cardType, int minute) {
    
        Player player = findPlayerByName(playerName);

        if (player != null) {
            Card card = new Card(player,team, cardType, minute);
