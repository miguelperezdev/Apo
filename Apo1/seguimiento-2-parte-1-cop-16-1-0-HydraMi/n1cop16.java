...
public class n1cop16 {
    ...
    public static void cedula(Scanner escaner, String nombre) {
        ...
        System.out.println("# Digita tu cedula (sin puntos ni comas): ");
        System.out.print("> ");
    ...
    public static void metereo(Scanner escaner) {
        ...
        System.out.println("\n# Digita la temperatura en grados centigrados °C (si es decimal con una , )");
        System.out.print("> ");
        double grados = escaner.nextDouble();

        System.out.println("\n# Digita el porcentaje relativo de humedad (si es decimal con una , )");
        System.out.print("> ");
