...
public class Main {
    ...
    private static void showMenu() {
        ...
        System.out.println("5. Generate Fixture and Assign Referees");
        System.out.println("6. Register Match Score");
        System.out.println("7. Register Goal");
        System.out.println("Register cards to playershola");
    ...
    public static void createControllerSoccer() {
        System.out.println("Add the name of the organizer: ");
        String organizatorName = scanner.nextLine();
        System.out.println("Start date of the tournament 10/01/2024 ");
        System.out.println("End date of the tournament 11/16/2024 ");
    ...
    public static void registerGoal() {
        System.out.println("=== Goal Registration ===");
    
        System.out.print("Enter the name of the player who scored the goal: ");
        String scorerName = scanner.nextLine();
    
        System.out.print("Enter the name of the player who assisted (leave blank if there was no assistant): ");
        String assistantName = scanner.nextLine();
    
        System.out.print("Enter the minute the goal was scored: ");
        int minute = scanner.nextInt();
    
        controller.registerGoal(scorerName, assistantName, minute);
    
        System.out.println("\nGoal registered successfully!");
    
        Goal goal = controller.getCurrentGoal();
        if (goal != null) {
            System.out.println(goal);
        } else {
            System.out.println("No goals registered.");
        }
    }
    ...
    public static void registerCard() {
        ...
        System.out.print("Enter the name of the player who received the card: ");
        String playerName = scanner.nextLine();

        System.out.println("Enter team");
        String team = scanner.nextLine();
    
        System.out.print("Enter the type of card (Yellow or Red): ");
        String cardType = scanner.nextLine();
    
        System.out.print("Enter the minute the card was given: ");
        int minute = scanner.nextInt();
    
        controller.registerCard(playerName,team, cardType, minute);
    
        System.out.println("\nCard registered successfully!");
    }
        //estoy acomodando que me deje darle una targeta a un jugador, el cual en la controller creo qu eesta el problema de team dado que no me 
        //lo registra 
